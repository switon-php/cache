# Switon Cache Package Tests

Test suite for the Switon Cache package, organized by test type and speed.
...
- **Proper Assertions**: Use specific assertions (`assertSame`, `assertArrayHasKey`)
...
- Follow naming convention: `Cache[Component]Test.php`
